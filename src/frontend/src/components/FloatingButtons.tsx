  ...
  return (
    <>
      ...
      >
        {waHovered && (
          <div
            className="glass-card px-3 py-1.5 rounded-lg text-xs font-medium shadow-glow-sm animate-fade-in"
            style={{
        ...
        <a
          ...
          className="flex items-center justify-center w-14 h-14 rounded-full shadow-glow-md transition-smooth hover:scale-110 animate-pulse-glow"
          // sr-only span added below inside element
          style={{
